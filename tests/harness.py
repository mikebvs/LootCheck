...
for name in ("Core.lua", "Data.lua", "TierTokens.lua", "Tooltip.lua", "Window.lua", "Drops.lua", "Graph.lua", "Wishlist.lua", "Awards.lua", "Imports.lua", "Comm.lua", "Help.lua", "Audit.lua", "Config.lua"):
