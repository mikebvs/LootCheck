...
for _, keyword in ipairs({ "graph", "drops", "council", "members", "sheet", "character", "char", "phase", "phases", "resetsize", "grouponly", "audit", "imports", "data", "use", "giveitem", "removeitem", "addwlitem",
